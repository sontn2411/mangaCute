        ...
        <View className="flex-1 bg-white dark:bg-black">
            ...
            <React.Fragment>
                <FlatList
                    ...
                    renderItem={({ item: chapter, index }: { item: any, index: number }) => {
                            ...
                            >
                                <View className="flex-row items-center bg-gray-50 dark:bg-zinc-900 p-3 rounded-2xl border border-gray-100 dark:border-zinc-800">
                                    <Link
                                        href={{
                                            pathname: '/chapter/[id]',
                                            params: { id: chapter.chapter_api_data, slug: manga.slug }
                                        }}
                                        asChild
                                    >
                ...
                chapters.length > 0 && (
                    <Animated.View entering={FadeInUp.delay(600)} className="absolute bottom-8 align-middle w-full px-12">
                        <Link
                            href={{
                                pathname: '/chapter/[id]',
                                params: { id: chapters[0].chapter_api_data, slug: manga.slug }
                            }}
                            asChild
                        >
